...
public class WmsNetApiHelper {
     ...
     */
    public static void getServerIP(String url,JsonHttpResponseHandler jsonHttpResponseHandler){
        AsyncHttpClientHelper.get(url,jsonHttpResponseHandler);
    }
     ...
     * @param jsonHttpResponseHandler JsonHttpResponseHandler
     */
    public static void login(String ip,String uid,String pwd,JsonHttpResponseHandler jsonHttpResponseHandler){
        String url=ip+TOKEN + "login.do";//登录
     ...
     * @param jsonHttpResponseHandler JsonHttpResponseHandler
     */
    public static void downProduct(String ip,String token,JsonHttpResponseHandler jsonHttpResponseHandler){
        String url=ip+TOKEN + "prod_list.do";
        RequestParams requestParams = new RequestParams();
     ...
     * @param jsonHttpResponseHandler JsonHttpResponseHandler
     */
    public static void downLogistPerson(String ip,String token,JsonHttpResponseHandler jsonHttpResponseHandler){
        String url=ip+TOKEN + "logist_person.do";
        RequestParams requestParams = new RequestParams();
        requestParams.put("token",token);
        AsyncHttpClientHelper.get(url,requestParams,jsonHttpResponseHandler);
    }
     ...
     */
    public static void downloadJXS(String ip,String token,JsonHttpResponseHandler jsonHttpResponseHandler){

        String url=ip+TOKEN + "supteam.do";
        RequestParams requestParams = new RequestParams();
        requestParams.put("token",token);
        AsyncHttpClientHelper.get(url,requestParams,jsonHttpResponseHandler);
    }
     ...
     * @param jsonHttpResponseHandler
     */
    public static void downloadWuLiu(String ip,String token,JsonHttpResponseHandler jsonHttpResponseHandler){

        String url=ip+TOKEN + "logisticsteam.do";
        RequestParams requestParams = new RequestParams();
        requestParams.put("token",token);
        AsyncHttpClientHelper.get(url,requestParams,jsonHttpResponseHandler);
    }
     ...
     * @param jsonHttpResponseHandler
     */
    public static void downloadWareHouse(String ip,String token,JsonHttpResponseHandler jsonHttpResponseHandler){

        String url=ip+TOKEN + "getwh.do";
        RequestParams requestParams = new RequestParams();
        requestParams.put("token",token);
        AsyncHttpClientHelper.get(url,requestParams,jsonHttpResponseHandler);
    }
     ...
     * @param jsonHttpResponseHandler
     */
    public static void downloadCarNum(String ip,String token,JsonHttpResponseHandler jsonHttpResponseHandler){

        String url=ip+TOKEN + "logisticscar.do";
        RequestParams requestParams = new RequestParams();
        requestParams.put("token",token);
        AsyncHttpClientHelper.get(url,requestParams,jsonHttpResponseHandler);
    }
     ...
     * @param jsonHttpResponseHandler
     */
    public static void downloadDriver(String ip,String token,JsonHttpResponseHandler jsonHttpResponseHandler){

        String url=ip+TOKEN + "logisticsperson.do";
        RequestParams requestParams = new RequestParams();
        requestParams.put("token",token);
        AsyncHttpClientHelper.get(url,requestParams,jsonHttpResponseHandler);
    }
